const flowers = [
  { id: 1, name: "White Rose", species: "Rose", price: 0.9 },
  {
    id: 2,
    name: "Red Tulip",
    species: "Tulip",
...
// You did it!! Congratulations on passing your first self-assement!
// Nice job with that for...of if loop! Didn't have to use another resource.
